<div>
        ...
        <div class="splide__track">
            <ul class="splide__list">
                <li class="splide__slide">
                    <img class="imageSlide" src="https://www.mervins.com.mx/storage/images/banners/OjfdL5Zs3RVo5BYTCmAxP7xAD8uc64MqoAj2OIR4.webp" alt="">
                </li>
                <li class="splide__slide">
    ...
    <!-- Segundo slide -->
    <section class="loading splide SlideSplideSecond" aria-label="Splide Basic HTML Example" data-splide='{"type":"loop","autoplay": true,"perPage": 10,"breakpoints": {"1240": {"perPage": 9},"1150": {"perPage": 8},"1010": {"perPage": 7},"870": {"perPage": 6},"730": {"perPage": 5},"615": {"perPage": 4},"470": {"perPage": 3}}}'>
        <div class="splide__arrows">
            <button class="splide__arrow splide__arrow--prev" style="opacity: 0;">
                Prev
            </button>
    ...
    <div class="loading nosotrosDiv slideDiv d-none d-md-block">
        <section class="row row-cols-xl-5 row-cols-lg-4 row-cols-md-3 row-cols-sm-2 row-cols-2">
            <div class="col">
                <div class="sectionNosotro">
                    <div class="datosNosotros">
                        <picture><img src="https://www.mervins.com.mx/assets/img/compra100segura.png" alt=""></picture>
                        <div class="texto">
            ...
            <div class="col">
                <div class="sectionNosotro">
                    <div class="datosNosotros">
                        <picture><img src="https://www.mervins.com.mx/assets/img/enviosatodomexico.png" alt=""></picture>
                        <div class="texto">
            ...
            <div class="col">
                <div class="sectionNosotro">
                    <div class="datosNosotros">
                        <picture><img src="	https://www.mervins.com.mx/assets/img/lasmejoresmarcas.png" alt=""></picture>
                        <div class="texto">
            ...
            <div class="col">
                <div class="sectionNosotro">
                    <div class="datosNosotros">
                        <picture><img src="https://www.mervins.com.mx/assets/img/promocionesexclusivas.png" alt=""></picture>
                        <div class="texto">
            ...
            <div class="col">
                <div class="sectionNosotro">
                    <div class="datosNosotros">
                        <picture><img src="	https://www.mervins.com.mx/assets/img/dinstintasformasdepago.png" alt=""></picture>
                        <div class="texto">
    ...
    <section class="loading bannersInicio d-none d-lg-block">
        <div class="bannerSection mb-4">
            <div class="banner bannerDown-G" data-aos="fade-right">
                <img class="imagenBanner bannerHover" src="https://www.mervins.com.mx/storage/photos/O2uLdDzzJiCPlubCYxPKhYXAijXr0TxzqOYP3kYN.png" alt="">
            </div>
            <div class="banner bannerDown-C" data-aos="fade-left">
                <img class="imagenBanner bannerHover" src="https://www.mervins.com.mx/storage/photos/FsPBfKkuqq5jENmq0yeYa2ZH5xafW7SoEFNMadkN.png" alt="">
            </div>
        </div>
        <div class="bannerSection">
            <div class="banner bannerDown-C" data-aos="fade-right">
                <img class="imagenBanner bannerHover" src="	https://www.mervins.com.mx/storage/photos/VEUZHtXL2Gz1d75FYVcwOPnQalCQxMMlWdDxSkH2.png" alt="">
            </div>
            <div class="banner bannerDown-G" data-aos="fade-left">
                <img class="imagenBanner bannerHover" src="	https://www.mervins.com.mx/storage/photos/BU8EsNDS4H5waK2Ks5FhILwDVEeu3KowlnT9op1k.png" alt="">
            </div>
        </div>
    </section>
        ...
        <section class="contenido">
                ...
                <div class="col col-lg-3 col-md-6 col-12 ">
                    <div class="centerDiv">
                        <div class="imagenLogoStafetaSello">
                            <img src="https://www.mervins.com.mx/images/shared/logo_comercioelectronico.png" alt="">
                        </div>
            ...
            <div class="extra row">
                ...
                <div class="col col-lg-8 col-12">
                    <div class="derechos">
                        <p>© Administración de Marketplace y Dropshipping Digital S.A. de C.V. - Todos los derechos reservados</p>
                    </div>
                </div>
    ...
    <div class="animacionInicio" id="animacionInicio">
        <picture id="animacion">
            ...
            <img id="boca" class="boca" src="{{ asset('images/animaciones/logo1Boca.png') }}" alt="">
        </picture>
    </div>
