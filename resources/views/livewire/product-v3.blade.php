<link rel="stylesheet" href="{{ asset('productV3.css') }}">
<section class="productV3Div" style="margin-left: auto; margin-right: auto;">
    ...
    <div style="position: absolute; top: 0; left: 0; width: 100%; height: 100%;">
        <div class="images">
            ...
            <picture class="img2">
                <img class="imageBN" src="{{ isset($product->img_path) ? $product->img_path : 'https://www.exel.com.mx/Repositorio/FTP/Contenidos/Imagenes/Productos/DEHLATAB301_zoom.jpg'}}" alt="">
            </picture>
        ...
        <div class="descriptions">
            <div class="title">
                <a href="/" class="name">{{ isset($product->name) ? substr($product->name, 0, 22) : ''}}..</a>
                <!-- <p class="fullName">{{ isset($product->name) ? $product->name : ''}}</p> -->
            </div>
