                ...
                <div class="section2">
                    ...
                    <div class="drop-content nav-arbol">
                        ...
                        <div class="drop-body">
                            @foreach ($arbol as $value)
                                <div class="button-div">
                                    ...
                                    <section class="menu-rigth">
                                        <div class="button-div"
                                            onclick="location.href='/search/{{ $value->busqueda }}'">
                                            {{ $value->name }}
                                        </div>
                                        @foreach ($value->getChilds as $child)
                                            <div class="button-div"
                                                onclick="location.href='/search/{{ $child->busqueda }}'">
                                                {{ $child->name }}
                                            </div>
                                        @endforeach
                                    </section>
                            ...
                            <div class="button-div" onclick="location.href='/jerarquia'">
                                Jeraquias
                            </div>
                    ...
                    @endphp
                    @if (isset($resultado))
                        <div class="category_jerarqui">
                            @foreach ($resultado['pathSpliceData'] as $item)
                                @php
                                    $i++;
                                @endphp
                    ...
                    {{-- <section class="categories">
                        ...
                        <div class="drop-content">
                                <button class="drop-menu-button"><span>Categorias</span><svg
                    ...
                    <section class="user">
                        ...
                        @auth
                            <div class="drop-content user-drop">
                                <button class="drop-menu-button">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                        fill="currentColor" class="bi bi-person svgUser" viewBox="0 0 16 16">
                                        <path
                                ...
                                <div class="drop-body">
                                    <section class="user-name">
                                        ...
                                        <section class="name-welcome">
                                            <p>!Hola {{ substr(explode(' ', auth()->user()->name)[0], 0, 8) }} Bienvenido¡
                                            </p>
                                        </section>
                                    </section>
                                    <hr>
                        ...
                        @auth
                            <a class="link wishlistLink" href=""><svg xmlns="http://www.w3.org/2000/svg"
                        ...
                        <a class="link cartLink" href=""><svg xmlns="http://www.w3.org/2000/svg"
